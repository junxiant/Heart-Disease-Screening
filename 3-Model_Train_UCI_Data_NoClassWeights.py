...
logging.basicConfig(level=logging.INFO, 
                    ...
                    handlers=[
                        logging.FileHandler("./logs/UCI_Data_Train_NoClassWeights.log"),
...
# Setup the data dir
saved_dir = './saved_models_uci_noclassweights'
saved_figs = './figs_uci_noclassweights/'
...
# num column:\ 0 = no heart disease\ 1 = mild heart disease\ 
...
def get_model_performance(model, param_grid, X_train, X_test, y_train, y_test):
    ...
    # Get cross-validation results of the best model
...
# classifiers['PyTorch Neural Network'] = (
#     PyTorchClassifier(input_dim=input_dim),
#     {
#         'epochs': [20],
#         'batch_size': [8],
